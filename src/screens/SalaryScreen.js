  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.content}>
        <Text style={styles.pageTitle}>Salary</Text>
        <Text style={styles.pageSub}>View your salary slips</Text>
        <View style={styles.card}>
          <Text style={styles.soon}>Coming Soon</Text>
          <Text style={styles.soonSub}>
            Monthly salary slips and payment history will be available here.
          </Text>
        </View>
      </View>
    </SafeAreaView>
